...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    public MockKafkaStreamRunner(TwitterToKafkaServiceConfiguration configData, TwitterKafkaStatusListener statusListener) {
    ...
    private String getRandomTweetContent(String[] keywords, int minTweetLength, int maxTweetLength) {
        ...
        int tweetLength = RANDOM.nextInt(maxTweetLength - maxTweetLength + 1) + minTweetLength;
